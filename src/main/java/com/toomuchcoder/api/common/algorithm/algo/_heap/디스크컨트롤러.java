 ...
 * author     : parkjungkwan
 * date       : 2022-05-24
 * desc       : https://programmers.co.kr/learn/courses/30/lessons/42627
 *
...
public class 디스크컨트롤러 {
    ...
    public static class Solution {
        ...
        public String toString() {
            return String.format("scoville : %s\nK : %d\nanswer: %d", Arrays.toString(jobs), answer);
        }
    }
    ...
    static class Service {
        SolutionService<Solution, Solution> f = e -> {
            ...
            return Solution.builder().jobs(e.getJobs()).answer(-1).build();
        };
    }
    ...
    void testSolution() {
        ...
        Solution s = Solution.builder().jobs(jobs).build();

package com.toomuchcoder.api.common.algorithm.algo._stackQueue;
...
public class 프린트 {
    ...
    class Service{
        SolutionService f = e->{
            ...
            Arrays.stream(e.getPriorities()).forEach(pq::offer);
    ...
    @Test
    void testSolution(){
        Integer[][] priorities = {{2, 1, 3, 2}, {1, 1, 9, 1, 1, 1}};
        int[] location = {2, 0};
        ...
        for (int i = 0; i < location.length; i++){
            ...
            Solution s = Solution.builder()
                    ...
                    .location(location[i]).build();
            System.out.println(service.test(s));
        }
